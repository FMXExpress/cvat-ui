...
*
* Vendored into cvat-canvas and converted from mouse events to pointer
* events so that drawing works with pen input (Apple Pencil). Touch
* pointer movement is ignored while drawing: fingers pan and pinch the
...
(function () {
    ...
    PaintHandler.prototype.stop = function (event) {
        ...
        SVG.off(window, 'pointermove.draw');
